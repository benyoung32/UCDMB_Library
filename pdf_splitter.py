...
class SplitGUI(tk.Toplevel):
    def __init__(self, parent, doc:fitz.Document, output_names:list[str]) -> None:
        ...
        done_button.grid(row=0,column=0,padx=20,sticky='nwes')
        separate_button.grid(row=0,column=1,columnspan=2,padx=20)
        self.output_entry.grid(row=0,column=3,columnspan=2,padx=20)
